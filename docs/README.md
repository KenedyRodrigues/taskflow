# Documentação do TaskFlow

- [Setup local e Supabase](setup.md)
...
Comece pelo README na raiz. Para modificar o código, leia arquitetura e segurança. Antes de publicar, siga os testes e o guia de deploy.
